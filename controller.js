...
function Pencil(ctx, drawing, canvas) {
  ...
  document
    ...
    .addEventListener(
      "change",
      (evt) => (this.currLineWidth = evt.target.value),
      false
    );
  document
    ...
    .addEventListener(
      "change",
      (evt) => (this.currColour = evt.target.value),
      false
    );
  new DnD(canvas, this);
  ...
  this.onInteractionStart = function (dnd) {
    ...
    this.hauteur = dnd.getYfinal() - dnd.getYInit();
    ...
    if (this.currEditingMode == editingMode.rect) {
      ...
      document.getElementById("shapeList").innerHTML = "<b>Rectangle</b>";
      ...
      // this.drawing.updateShapeList();
      document.getElementById("shapeList").innerHTML = "<b>ligne</b>";
    }
